...
ERROR_DICT = {
 ...
 301: ('INITIALIZE', ''),
 302: ('NO_ALIAS', 'Wrong alias name'),
 303: ('ALIAS_EXISTS', 'Alias name already exists'),
 304: ('BAD_VALUE', ''),
 305: ('INFINITE_LOOP', ''),
...
DEFAULT_ERROR = 'UNKNOWN_ERROR_CODE', ''
